...
ScrollTrigger.matchMedia({
    ...
    "(min-width: 768px)": function() {
        ...
        gsap.set('.lankmark_container .section6 .logo_list_wrap ul.logo_list_2', {
            willChange: 'transform', 
            y: contentH,
            ease: 'none', 
            force3D: true,
        ...
        .to('.section6 .logo_list_1', 
            {yPercent: 0, y: contentH, ease: "none", force3D: true, willChange: 'transform'}
        )
        .to('.section6 .logo_list_2', 
            {yPercent: -100, y: 0, ease: "none", force3D: true, willChange: 'transform'}
        ,"<");
    },
    // --- Mobile (가로 767px 이하) ---
